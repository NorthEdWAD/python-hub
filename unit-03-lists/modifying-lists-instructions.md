...
*Students will learn how to modify, add and remove elements (items) from a Python list.*
...
1. Create **NEW** GitHub repo: `modifying-lists`
...
## 🚀 Getting Started
1. Create a new project folder on your laptop.
